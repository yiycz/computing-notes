...
> **1ai**	62842281 = 3*16^6 + 11*16^5 + 14*16^4 + 14*16^3 + 5*16^2 + 10*16^1 + 9*16^0
> 3BEE5A9
...
> Convert the phone number 62842281 to:
> **Hexadecimal** representation[2]
> 62842281 = 3*16^6 + 11*16^5 + 14*16^4 + 14*16^3 + 5*16^2 + 10*16^1 + 9*16^0 [1]Or repeated division by 16 3BEE5A9 [1]
> **ASCII** value for each digit.
> ('0' has an **ASCII** value of 48 and '9' has an **ASCII** value of 57.)[2]
...
> **(a)** Write table definitions, indicating the **primary key** with underline and **foreign key** with *, for each of the
